...
void init(const Param& param, Variables& var)
{
    ...
    *var.volume_old = *var.volume;
    ...
    initial_stress_state(param, var, *var.stress, *var.emt_iso_stress, *var.stressyy, *var.strain, var.compensation_pressure);
...
void restart(const Param& param, Variables& var)
{
    ...
    // Initializing field variables
    {
        ...
        bin_save.read_array(*var.emt_iso_stress, "emt_iso_stress");
...
void isostasy_adjustment(const Param &param, Variables &var)
{
    ...
    for (int n=0; n<iso_steps; n++) {
        ...
        update_stress(var, *var.stress, *var.emt_iso_stress, *var.stressyy, *var.dpressure, *var.strain,
...
int main(int argc, const char* argv[])
{
	...
	NMD_stress(var, *var.ntmp, *var.stress, *var.emt_iso_stress, *var.tmp_result_sg);
        ...
        if (var.mat->rheol_type & MatProps::rh_elastic)
            rotate_stress(var, *var.stress, *var.emt_iso_stress, *var.strain);
