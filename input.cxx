                               ...
                               Param &p)
{
    ...
    cfg.add_options()
        ("mat.rheology_type", po::value<std::string>()->required(),
         ...
         "'elasto-plastic', 'emt', or 'elasto-visco-plastic'.")
        ...
        ("mat.initial_crack_normal", po::value<std::string>()->default_value("[0]"),
...
static void validate_parameters(const po::variables_map &vm, Param &p)
{
    ...
    //
    {
        ...
        else if (str == std::string("emt"))
            p.mat.rheol_type = MatProps::rh_emt;
