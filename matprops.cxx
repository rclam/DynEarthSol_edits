...
MatProps::MatProps(const Param& p, const Variables& var) :
  ...
  stress(*var.stress),
  emt_iso_stress(*var.emt_iso_stress),
  ...
  elemmarkers(*var.elemmarkers)
{
    ...
    initial_crack_normal = p.mat.initial_crack_normal;
    emt_crack_density = p.mat.emt_crack_density;
    emt_pf = p.mat.emt_pf;
...
double MatProps::emt_pf_z(int e) const
{
    return harmonic_mean(emt_pf, elemmarkers[e]);
}
  ...
  elemmarkers(*var.elemmarkers)
{
    ...
    emt_pf = VectorBase::create(p.mat.emt_pf, nmat);
