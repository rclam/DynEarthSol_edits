...
void NMD_stress(const Variables &var, double_vec &dp_nd, tensor_t& stress, tensor_t& emt_iso_stress,
                double_vec &tmp_result_sg)
{
     ...
     */
    #pragma omp parallel for default(none)      \
        shared(connectivity,dp_nd,stress,emt_iso_stress,dpressure,var_nelem)
